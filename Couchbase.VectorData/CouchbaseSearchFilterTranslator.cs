...
/// </summary>
internal class CouchbaseSearchFilterTranslator : FilterTranslatorBase
{
    /// <summary>
    ...
    public ISearchQuery? Translate<TRecord>(Expression<Func<TRecord, bool>> filter, CollectionModel model)
    {
        ...
        var preprocessedExpression = PreprocessFilter(filter, model, new FilterPreprocessingOptions { SupportsParameterization = false });
